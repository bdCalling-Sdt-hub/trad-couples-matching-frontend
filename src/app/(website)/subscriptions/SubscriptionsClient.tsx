        ...
        <div className='container flex items-center justify-center h-full'>
            <div className='h-[80vh] w-full flex flex-col items-center justify-center gap-8'>
                {data.map((value, index) => (
                    <div
                        key={value.id}
                        className="flex items-center group w-[60%] bg-gray-100 hover:bg-gray-50 p-5 rounded-lg border-[2px] border-[#dfdada] hover:border-gray-200 transition-transform transform-gpu hover:-translate-y-2 hover:scale-105 hover:shadow-lg duration-300 ease-out"
                    >
                        <input
                            id={`checkbox-${index}`}
                            type="checkbox"
                        ...
                        <div className='ps-3'>
                            ...
                            <p className='text-[#6B6B6B] text-[17px] py-3 w-[85%]'>

...
export const height = [
    ...
    {
        value: "152cm-160cm",
        label: <p>5'0" – 5'3" (152 – 160 cm)</p>
    },
    {
        value: "161cm-170cm",
        label: <p>5'4" – 5'7" (161 – 170 cm) </p>
    },
    {
        value: "171cm-180cm",
        label: <p>5'8" – 5'11" (171 – 180 cm)</p>
    },
    {
        value: "181cm-191cm",
        label: <p>6'0" – 6'3" (181 – 191 cm)</p>
    },
    {
        value: "191cm+",
...
export const livingEnvironment = [
    ...
    { value: "Urban Living", label: "Urban Living" },
    { value: "Either / Open to All", label: "Either / Open to All" }
];
...
export const occupation = [
    ...
    { value: "Legal / Law Enforcement", label: "Legal / Law Enforcement" },
    { value: "Marketing / Advertising", label: "Marketing / Advertising" },
    { value: "Sales / Customer Service", label: "Sales / Customer Service" },
...
export const willingToMotherOthersChildren = [
    { value: "Yes", label: "Yes" },
    { value: "No", label: "No" }
];

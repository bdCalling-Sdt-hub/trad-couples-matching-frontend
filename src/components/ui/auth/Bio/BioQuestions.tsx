...
import { ConfigProvider, DatePicker, Form, Input, Progress, TreeSelect } from 'antd';


import QuestionDropdown from '@/components/shared/QuestionDropdown';
import { Poppins } from 'next/font/google';
import { height, bodyShape, educationOn, ethnicity, country, province, hairColor, eyeColor, maritalStatus, relocationWillingness, livingEnvironment, occupation, universityFrom  , custodyStatus } from "@/components/shared/Option"
                          ...
                          <Form.Item
                            ...
                            >
                                <TreeSelect
                                    ...
                                    treeData={universityFrom}
                                    style={{ height: 45 }}
                                    dropdownStyle={{ maxHeight: 400, overflow: 'auto' }}
                                    treeDefaultExpandAll 
                                    onChange={(value) => handleChange('educationFrom', value)}
                                />
                            </Form.Item>

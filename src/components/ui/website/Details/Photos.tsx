...
<Image src={profile1} alt='' height={500} width={500} style={{height:"350px" , width:"370px" , borderRadius:"10px"}} />

            <div className='grid lg:grid-cols-5 grid-cols-1 items-center gap-5 mt-5'>
            {
                images?.map((value , index:number) =><div key={index}> 
 <Image src={value} alt='' height={500} width={500} style={{height:"350px" , width:"370px" , borderRadius:"10px"}} />
                </div>)
            }
            </div>
        </div>

        ...
        <div className='container'>
            <div className=' grid grid-cols-12 gap-5 mt-8'>
                ...
                ${isFilter ? 0 : 270}deg)`
                        ...
                        {/* reload  */}
                        <button className={`bg-black text-white w-[60px] h-[45px] rounded-lg flex justify-center items-center`}>
                            <TfiReload size={22} />
                        </button>
                    ...
                    {
                        isFilter ?
                            <div className={`bg-[#F7F7F7] p-2 w-full transition-all duration-600 ease-in-out z-10`}>
                                <Form layout='vertical'>
                                    <DropdownInput name='shortBy' label='Short by' defaultValue='Newest' options={ShortBy} />
                                    <DropdownInput name='location' label='Location' defaultValue='BanglaDesh' options={location} />
                                    <DropdownInput name='maritalStatus' label='Marital Status' defaultValue='Single' options={MaritalStatus} />
                                    <DropdownInput name='children' label='Children' defaultValue='1' options={children} />
                                    <DropdownInput name='height' label='Height' defaultValue='150cm' options={height} />
                                    <DropdownInput name='bodyShape' label='Body Shape' defaultValue='Fit' options={bodyShape} />
                                    <DropdownInput name='hairColor' label='Hair Color' defaultValue='Black' options={hairColor} />
                                    <DropdownInput name='eyeColor' label='Eye Color' defaultValue='Black' options={eyeColor} />
                                    <DropdownInput name='education' label='Education' defaultValue='Graduate' options={education} />
                                    <DropdownInput name='occupation' label='Occupation' defaultValue='Teacher' options={occupation} />
                                    <DropdownInput name='religion' label='Religion' defaultValue='Cristian' options={religion} />
                ...
                <div className='lg:col-span-9 col-span-12 mb-5 '>
                    <div className=' grid lg:grid-cols-3 grid-cols-2 gap-8 z-0 '>
                        {
